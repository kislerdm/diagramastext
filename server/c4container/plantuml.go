...
func (c *clientPlantUML) Do(ctx context.Context, v Graph) ([]byte, error) {
	...
	return c.requestHandler(ctx, "svg/"+p)
}
...
func NewClient(optFns ...func(*optionsPlantUMLClient)) Client {
...
func diagramGraph2plantUMLCode(graph Graph) (string, error) {
