...
func addWeightedFreqs(
	stats1 symbolStats, w1 float64,
	stats2 symbolStats, w2 float64,
) (result symbolStats) {
...
func (s *BlockState) bestLengths(
	inStart, inEnd int, costModel costModelFun, costContext interface{},
) (lengths []uint16) {
...
func (s *BlockState) lz77OptimalRun(
	inStart, inEnd int, costModel costModelFun, costContext interface{},
) (store LZ77Store) {
